...
qualtrics=fread("12_18 Virtual Lab - New Participant Intake form_December 18, 2020_21.07.csv") #UPDATE
...
qualtrics$StartDate=as_datetime(substr(as.character(qualtrics$StartDate),1,nchar(as.character(qualtrics$StartDate))-3),
                                format="%Y-%m-%d %H:%M")
#getting enddate into date format (just in case)
qualtrics$EndDate=as.POSIXct(qualtrics$EndDate,format="%m/%d/%y %H:%M")
...
#input date range
#YYYY-MM-DD HH:MM:SS"
date_begin="2020-12-16 13:21:00" #UPDATE
date_end="2020-12-22 11:59:00"   #UPDATE
